## AWS Waf module for CloudFront
This module deploy AWS WAF on Amazon CloudFront as part of your CDN solution
...
| endpoint | Endpoint type, select one of alb and cloudfront | string | `cloudfront` | no |
...
| stack_name | AWS service name which waf applied to, it contains two types, ELB and CloudFront | string | `CloudFrontStack` | no |
